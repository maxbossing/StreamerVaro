...
public class AddStrikesCommand implements CommandExecutor {

    /*
     *This Command allows Operators to add Strikes to the Player
     */
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length != 2) {
            player.sendMessage(ERROR + ChatColor.GOLD + "Usage : /addstrikes <Player> <amount>");
            return true;
        }
        ...
        if (target == null) {
            ...
            try {
                ...
                Strikes.incrementStrikes(target.getUniqueId(), addStrikes);
